        ...
        <div className="grid md:grid-cols-6 gap-10">
          <div className="md:col-span-2">
            ...
            <div className="mt-5 text-sm text-premium/60 space-y-2">
              ...
              <p className="flex items-center gap-2"><Mail size={15} className="text-cyber" /> {SITE.email}</p>
              <p className="flex items-center gap-2"><Phone size={15} className="text-cyber" /> {SITE.whatsapp}</p>
