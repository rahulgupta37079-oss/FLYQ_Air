...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>FLYQ - The Future of Flight</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .drone-container {
            ...
            width: 500px;
            height: 500px;
            animation: droneEntry 2s ease-out forwards;
            transform-style: preserve-3d;
        }

        @keyframes droneEntry {
            0% {
                transform: translateY(-200vh) rotateX(45deg) scale(0.5);
                opacity: 0;
            }
            60% {
        ...
        .propeller-container.p1 {
            top: 15%;
            left: 15%;
        }

        .propeller-container.p2 {
            top: 15%;
            right: 15%;
        }

        .propeller-container.p3 {
            bottom: 15%;
            left: 15%;
        }

        .propeller-container.p4 {
            bottom: 15%;
            right: 15%;
        }
        ...
        .progress-container {
            ...
            width: 300px;
            opacity: 0;
            animation: progressFade 1s ease-out 3s forwards;
        }
        ...
        .skip-button {
            ...
            transition: all 0.3s ease;
            opacity: 0;
            animation: skipFade 1s ease-out 4s forwards;
            font-size: 0.9rem;
            letter-spacing: 0.1em;
            text-transform: uppercase;
        }
...
<body>
    <div class="intro-container">
        ...
        <div class="drone-container">
            <div class="drone">
                ...
                <div class="drone-body">
                    <div class="led front"></div>
                    <div class="led back"></div>
                </div>
                ...
                <!-- Propellers -->
                <div class="propeller-container p1">
                    <div class="propeller">
                        <div class="blade"></div>
                        <div class="blade"></div>
                    </div>
                ...
                <div class="propeller-container p2">
                    <div class="propeller">
                        <div class="blade"></div>
                        <div class="blade"></div>
                    </div>
                ...
                <div class="propeller-container p3">
                    <div class="propeller">
                        <div class="blade"></div>
                        <div class="blade"></div>
                    </div>
                ...
                <div class="propeller-container p4">
                    <div class="propeller">
                        <div class="blade"></div>
                        <div class="blade"></div>
                    </div>
        ...
        <div class="text-container">
            <h1 class="brand-name">FLYQ</h1>
            <p class="tagline">The Future of Flight</p>
        </div>
        ...
        <!-- Skip Button -->
        <button class="skip-button" onclick="window.location.href='/'">Skip Intro</button>
    </div>
...
app.get('/track/:id', (c) => {
  ...
  // Generate random delivery date (Feb 7 or 8, 2026)
  const deliveryDay = Math.random() < 0.5 ? 7 : 8;
  const deliveryDate = deliveryDay === 7 ? 'February 7, 2026' : 'February 8, 2026';
  const deliveryDateShort = deliveryDay === 7 ? 'Feb 7' : 'Feb 8';
  
  // Calculate days delayed (today is Feb 2, expected was Feb 4-5)
  const daysDelayed = deliveryDay - 5; // 2-3 days delayed
