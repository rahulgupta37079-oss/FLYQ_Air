  ...
  return `
    ...
    <head>
        ...
        <style>
            ...
            .video-masked {
                /* Advanced background removal for video */
            ...
            /* Green screen effect simulation */
...
app.get('/', (c) => {
  const content = `
    <div class="bg-black">
        <!-- Cinematic Hero Section - Military Style -->
        <section class="relative bg-black text-white overflow-hidden min-h-screen flex flex-col justify-between">
            ...
            <div class="container mx-auto px-4 md:px-6 relative z-10">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 max-w-6xl mx-auto">
                    ${[
                        ...
                        { label: 'FLIGHT TIME', value: '5-7', unit: 'minutes' },
                        { label: 'MOTOR TYPE', value: 'Coreless', unit: '8.5x20mm' },
        ...
        <div class="container mx-auto px-6">
            <div class="grid lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
                ...
                <div>
                    ...
                    <!-- Delivery Timeline - Enhanced Visual Design -->
                    <div class="mt-8 border-t pt-8">
                        <h3 class="font-bold text-2xl mb-6 flex items-center">
                        ...
                        <div class="relative mb-12">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex flex-col items-center z-10">
                                    <div class="w-14 h-14 bg-gradient-to-br from-green-500 to-green-600 rounded-full flex items-center justify-center text-white shadow-2xl mb-3 ring-4 ring-green-100">
                                        <i class="fas fa-check text-lg"></i>
                                    </div>
                                    <span class="text-xs font-semibold text-gray-700 text-center w-20">Order<br/>Placed</span>
                                </div>
                                
                                <!-- Step 2 -->
                                <div class="flex flex-col items-center z-10">
                                    <div class="w-14 h-14 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white shadow-2xl mb-3 ring-4 ring-blue-100">
                                        <i class="fas fa-box text-lg"></i>
                                    </div>
                                    <span class="text-xs font-semibold text-gray-700 text-center w-20">Picked<br/>Up</span>
                                </div>
                                
                                <!-- Step 3 -->
                                <div class="flex flex-col items-center z-10">
                                    <div class="w-14 h-14 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-full flex items-center justify-center text-white shadow-2xl mb-3 ring-4 ring-cyan-100 animate-pulse">
                                        <i class="fas fa-truck text-lg"></i>
                                    </div>
                                    <span class="text-xs font-semibold text-gray-700 text-center w-20">In<br/>Transit</span>
                                </div>
                                
                                <!-- Step 4 -->
                                <div class="flex flex-col items-center z-10">
                                    <div class="w-14 h-14 bg-gradient-to-br from-purple-500 to-purple-600 rounded-full flex items-center justify-center text-white shadow-2xl mb-3 ring-4 ring-purple-100">
                                        <i class="fas fa-home text-lg"></i>
                                    </div>
                                    <span class="text-xs font-semibold text-gray-700 text-center w-20">Delivered</span>
                                </div>
                            </div>
                            
                            <!-- Progress Line -->
                            <div class="absolute top-7 left-0 right-0 h-1.5 bg-gradient-to-r from-green-300 via-blue-300 via-cyan-300 to-purple-200 -z-0" style="margin-left: 28px; margin-right: 28px;"></div>
                        </div>

                        <!-- Detailed Timeline Cards -->
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <!-- Card 1 -->
                            <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-5 border-l-4 border-green-500 shadow-md hover:shadow-xl transition-shadow">
                                <div class="flex items-start gap-4">
                                    ...
                                    <div class="flex-1">
                                        <div class="font-bold text-gray-800 text-lg mb-1">Order Confirmed</div>
                                        <div class="text-sm text-gray-600 mb-2">Within 24 hours of payment</div>
                                        <div class="inline-flex items-center gap-1.5 bg-white/70 px-3 py-1 rounded-full text-xs font-medium text-green-700">
                            ...
                            <!-- Card 2 -->
                            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-5 border-l-4 border-blue-500 shadow-md hover:shadow-xl transition-shadow">
                                <div class="flex items-start gap-4">
                                    <div class="flex-shrink-0">
                                    ...
                                    <div class="flex-1">
                                        <div class="font-bold text-gray-800 text-lg mb-1">Picked Up</div>
                                        <div class="text-sm text-gray-600 mb-2">1-2 days after confirmation</div>
                                        <div class="inline-flex items-center gap-1.5 bg-white/70 px-3 py-1 rounded-full text-xs font-medium text-blue-700">
                            ...
                            <!-- Card 3 -->
                            <div class="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-xl p-5 border-l-4 border-cyan-500 shadow-md hover:shadow-xl transition-shadow">
                                <div class="flex items-start gap-4">
                                    <div class="flex-shrink-0">
                                    ...
                                    <div class="flex-1">
                                        <div class="font-bold text-gray-800 text-lg mb-1">In Transit</div>
                                        <div class="text-sm text-gray-600 mb-2">2-4 days shipping time</div>
                                        <div class="inline-flex items-center gap-1.5 bg-white/70 px-3 py-1 rounded-full text-xs font-medium text-cyan-700">
                            ...
                            <!-- Card 4 -->
                            <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-5 border-l-4 border-purple-500 shadow-md hover:shadow-xl transition-shadow">
                                <div class="flex items-start gap-4">
                                    <div class="flex-shrink-0">
                                    ...
                                    <div class="flex-1">
                                        <div class="font-bold text-gray-800 text-lg mb-1">Delivered</div>
                                        <div class="text-sm text-gray-600 mb-2">Total: 5-7 business days</div>
                                        <div class="inline-flex items-center gap-1.5 bg-white/70 px-3 py-1 rounded-full text-xs font-medium text-purple-700">
                        ...
                        <!-- Info Box -->
                        <div class="bg-gradient-to-r from-sky-50 to-blue-50 rounded-xl p-5 border border-sky-200 shadow-md">
                            <div class="flex items-start gap-4">
                                <div class="flex-shrink-0">
                                ...
                                <div class="flex-1">
                                    <div class="font-bold text-gray-800 mb-2">Real-Time Tracking Available</div>
                                    <div class="text-sm text-gray-700 leading-relaxed">
                                        You'll receive a <strong>tracking ID via email</strong> once your order ships. 
                                        Track your package in real-time from Mumbai to your doorstep with live updates at every step.
                                    </div>
                                </div>
                            </div>
                        </div>
...
app.get('/api/debug/bindings', (c) => {
  ...
  return c.json({
    DB: hasDB ? 'Available' : 'Not Available',
    R2: hasR2 ? 'Available' : 'Not Available',
    env_keys: c.env ? Object.keys(c.env) : []
  });
});

// ==================== ORDER TRACKING ====================
// Main tracking form page
    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50 py-12">
      <div class="container mx-auto px-6 max-w-2xl">
        <div class="bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <form method="GET" action="/track-order" class="max-w-md mx-auto" onsubmit="event.preventDefault(); const id = document.getElementById('tracking').value; if(id) window.location.href='/track/'+id;">
            <input 
              id="tracking"
              type="text" 
              name="tracking" 
...
// Tracking result page using path parameter (workaround for query param issue)
app.get('/track/:id', (c) => {
  const trackingId = c.req.param('id');
  const safeTrackingId = String(trackingId || '').replace(/[<>"']/g, '');
  
  // Generate random delivery date (Feb 14 or 15, 2026)
  const deliveryDay = Math.random() < 0.5 ? 14 : 15;
  const deliveryDate = deliveryDay === 14 ? 'February 14, 2026' : 'February 15, 2026';
  const deliveryDateShort = deliveryDay === 14 ? 'Feb 14' : 'Feb 15';
  
  // Calculate days delayed (today is Feb 3, expected was Feb 4-5)
  const daysDelayed = deliveryDay - 5; // 9-10 days delayed
...
app.get('/summer-camp', (c) => {
  const content = `
    ...
    <div class="pt-20 bg-black overflow-hidden">
                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="text-center mb-12 md:mb-16 animate-fadeInUp">
                        ...
                        <h2 class="text-4xl md:text-5xl lg:text-6xl font-black mb-6">
                            Watch Our <span class="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent animate-gradient">Drones in Action</span>
                        </h2>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-12">
                        ...
                        <div class="group relative bg-gradient-to-br from-purple-500/10 to-pink-400/10 backdrop-blur-lg rounded-2xl overflow-hidden border-2 border-purple-400/30 hover:border-purple-400 transition-all duration-500 hover:scale-[1.03] hover:shadow-2xl hover:shadow-purple-500/30">
                            ...
                            <div class="p-4">
                                <h3 class="text-lg font-bold text-white group-hover:text-purple-400 transition-colors">
                                    <i class="fas fa-rocket mr-2"></i>Flight Practice
                                </h3>
                            </div>
                        </div>

                        <!-- Video 5 -->
                        <div class="group relative bg-gradient-to-br from-yellow-500/10 to-orange-400/10 backdrop-blur-lg rounded-2xl overflow-hidden border-2 border-yellow-400/30 hover:border-yellow-400 transition-all duration-500 hover:scale-[1.03] hover:shadow-2xl hover:shadow-yellow-500/30">
                            <div class="aspect-video bg-gray-900 relative overflow-hidden">
                                <video 
                                    class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                                    controls
                            ...
                            <div class="p-4">
                                <h3 class="text-lg font-bold text-white group-hover:text-yellow-400 transition-colors">
                                    <i class="fas fa-certificate mr-2"></i>Camp Highlights
                                </h3>
                            </div>
                        </div>

                        <!-- Video 6 -->
                        <div class="group relative bg-gradient-to-br from-red-500/10 to-pink-400/10 backdrop-blur-lg rounded-2xl overflow-hidden border-2 border-red-400/30 hover:border-red-400 transition-all duration-500 hover:scale-[1.03] hover:shadow-2xl hover:shadow-red-500/30">
                            <div class="aspect-video bg-gray-900 relative overflow-hidden">
                                <video 
                                    class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                                    controls
                            ...
                            <div class="p-4">
                                <h3 class="text-lg font-bold text-white group-hover:text-red-400 transition-colors">
                                    <i class="fas fa-award mr-2"></i>Expert Guidance
                                </h3>
                            </div>
                        </div>

                        <!-- Video 7 -->
                        <div class="group relative bg-gradient-to-br from-indigo-500/10 to-purple-400/10 backdrop-blur-lg rounded-2xl overflow-hidden border-2 border-indigo-400/30 hover:border-indigo-400 transition-all duration-500 hover:scale-[1.03] hover:shadow-2xl hover:shadow-indigo-500/30">
                            <div class="aspect-video bg-gray-900 relative overflow-hidden">
                                <video 
                                    class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                                    controls
                            ...
                            <div class="p-4">
                                <h3 class="text-lg font-bold text-white group-hover:text-indigo-400 transition-colors">
                                    <i class="fas fa-cog mr-2"></i>Technical Training
                                </h3>
                            </div>
                        </div>

                        <!-- Video 8 -->
                        <div class="group relative bg-gradient-to-br from-teal-500/10 to-cyan-400/10 backdrop-blur-lg rounded-2xl overflow-hidden border-2 border-teal-400/30 hover:border-teal-400 transition-all duration-500 hover:scale-[1.03] hover:shadow-2xl hover:shadow-teal-500/30">
                            <div class="aspect-video bg-gray-900 relative overflow-hidden">
                                <video 
                                    class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                                    controls
                            ...
                            <div class="p-4">
                                <h3 class="text-lg font-bold text-white group-hover:text-teal-400 transition-colors">
                                    <i class="fas fa-camera mr-2"></i>Aerial Photography
                                </h3>
                            </div>
                        </div>

                        <!-- Video 9 -->
                        <div class="group relative bg-gradient-to-br from-rose-500/10 to-red-400/10 backdrop-blur-lg rounded-2xl overflow-hidden border-2 border-rose-400/30 hover:border-rose-400 transition-all duration-500 hover:scale-[1.03] hover:shadow-2xl hover:shadow-rose-500/30">
                            <div class="aspect-video bg-gray-900 relative overflow-hidden">
                                <video 
                                    class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                                    controls
                        ...
                        <!-- Video 10 -->
                        <div class="group relative bg-gradient-to-br from-violet-500/10 to-purple-400/10 backdrop-blur-lg rounded-2xl overflow-hidden border-2 border-violet-400/30 hover:border-violet-400 transition-all duration-500 hover:scale-[1.03] hover:shadow-2xl hover:shadow-violet-500/30 lg:col-span-1">
                            <div class="aspect-video bg-gray-900 relative overflow-hidden">
                                <video 
                                    class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                                    controls
                            ...
                            <div class="p-4">
                                <h3 class="text-lg font-bold text-white group-hover:text-violet-400 transition-colors">
                                    <i class="fas fa-shield-alt mr-2"></i>Safety Training
                                </h3>
                            </div>
                        </div>

                        <!-- Video 11 -->
                        <div class="group relative bg-gradient-to-br from-amber-500/10 to-yellow-400/10 backdrop-blur-lg rounded-2xl overflow-hidden border-2 border-amber-400/30 hover:border-amber-400 transition-all duration-500 hover:scale-[1.03] hover:shadow-2xl hover:shadow-amber-500/30 lg:col-span-2">
                            <div class="aspect-video bg-gray-900 relative overflow-hidden">
                                <video 
                                    class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                                    controls
                            ...
                            <div class="p-4">
                                <h3 class="text-lg font-bold text-white group-hover:text-amber-400 transition-colors">
                                    <i class="fas fa-star mr-2"></i>Complete Camp Overview
                                </h3>
                            </div>
                        </div>
        ...
        <section class="py-16 md:py-24 bg-gradient-to-br from-blue-950 via-black to-cyan-950 relative overflow-hidden">
            <!-- Animated Gradient Background -->
            <div class="absolute inset-0 opacity-30">
                <div class="absolute inset-0 bg-gradient-to-r from-blue-500/20 via-cyan-500/20 to-blue-500/20 animate-gradient"></div>
            </div>
                ...
                <div class="max-w-6xl mx-auto">
                    ...
                    <div class="text-center mb-12 md:mb-16">
                        <div class="inline-flex items-center gap-3 mb-6">
                            ...
                            <span class="bg-gradient-to-r from-blue-500 to-cyan-400 text-white px-6 py-2 rounded-full text-sm font-bold uppercase tracking-wider shadow-lg">
                                <i class="fas fa-gift mr-2"></i>Registration Benefits
                            </span>
                            <div class="h-px w-12 bg-gradient-to-r from-blue-400 to-transparent"></div>
                        </div>
                        
                        <h2 class="text-4xl md:text-5xl lg:text-6xl font-black mb-6">
                            What's Included in Your<br/>
                            <span class="bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent">₹2,500 Registration Fee</span>
                        </h2>
                        
                        <p class="text-xl md:text-2xl text-gray-300 mb-4">
                            Secure Your Spot Today & Get These Exclusive Benefits
                        </p>
                        
                        <div class="inline-block bg-yellow-500/20 border-2 border-yellow-400/50 rounded-2xl px-6 py-3 backdrop-blur-lg">
                            <p class="text-lg md:text-xl text-yellow-300 font-semibold">
                                <i class="fas fa-info-circle mr-2"></i>
                                Registration Fee Only - Additional Course Materials May Apply
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-12">
                        <!-- Benefit 1 -->
                        <div class="group bg-gradient-to-br from-blue-500/20 to-blue-600/10 backdrop-blur-lg p-6 md:p-8 rounded-3xl border-2 border-blue-400/30 hover:border-blue-400 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/30">
                            <div class="bg-blue-500 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                                <i class="fas fa-graduation-cap text-white text-3xl"></i>
                            </div>
                            <h3 class="text-xl md:text-2xl font-bold text-white mb-3">3-Day Workshop Access</h3>
                            <p class="text-gray-300 leading-relaxed">
                                Complete access to all 3 days of hands-on drone training, expert sessions, and flight practice
                            </p>
                        </div>

                        <!-- Benefit 2 -->
                        <div class="group bg-gradient-to-br from-cyan-500/20 to-cyan-600/10 backdrop-blur-lg p-6 md:p-8 rounded-3xl border-2 border-cyan-400/30 hover:border-cyan-400 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/30">
                            <div class="bg-cyan-500 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                                <i class="fas fa-drone text-white text-3xl"></i>
                            </div>
                            <h3 class="text-xl md:text-2xl font-bold text-white mb-3">Live Drone Flying</h3>
                            <p class="text-gray-300 leading-relaxed">
                                Real drone flight experience with professional FLYQ drones used by Army & ISRO
                            </p>
                        </div>

                        <!-- Benefit 3 -->
                        <div class="group bg-gradient-to-br from-green-500/20 to-green-600/10 backdrop-blur-lg p-6 md:p-8 rounded-3xl border-2 border-green-400/30 hover:border-green-400 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-green-500/30">
                            <div class="bg-green-500 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                                <i class="fas fa-certificate text-white text-3xl"></i>
                            </div>
                            <h3 class="text-xl md:text-2xl font-bold text-white mb-3">Certificate of Completion</h3>
                            <p class="text-gray-300 leading-relaxed">
                                Official FLYQ Drones certificate recognized for skill development and future opportunities
                            </p>
                        </div>

                        <!-- Benefit 4 -->
                        <div class="group bg-gradient-to-br from-purple-500/20 to-purple-600/10 backdrop-blur-lg p-6 md:p-8 rounded-3xl border-2 border-purple-400/30 hover:border-purple-400 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/30">
                            <div class="bg-purple-500 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                                <i class="fas fa-user-tie text-white text-3xl"></i>
                            </div>
                            <h3 class="text-xl md:text-2xl font-bold text-white mb-3">Expert Instructors</h3>
                            <p class="text-gray-300 leading-relaxed">
                                Learn from certified drone pilots with Army demonstration and ISRO showcase experience
                            </p>
                        </div>

                        <!-- Benefit 5 -->
                        <div class="group bg-gradient-to-br from-yellow-500/20 to-yellow-600/10 backdrop-blur-lg p-6 md:p-8 rounded-3xl border-2 border-yellow-400/30 hover:border-yellow-400 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-yellow-500/30">
                            <div class="bg-yellow-500 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                                <i class="fas fa-shield-alt text-white text-3xl"></i>
                            </div>
                            <h3 class="text-xl md:text-2xl font-bold text-white mb-3">Safety Training & Gear</h3>
                            <p class="text-gray-300 leading-relaxed">
                                Comprehensive safety protocols, protective equipment, and supervised flight training
                            </p>
                        </div>

                        <!-- Benefit 6 -->
                        <div class="group bg-gradient-to-br from-red-500/20 to-red-600/10 backdrop-blur-lg p-6 md:p-8 rounded-3xl border-2 border-red-400/30 hover:border-red-400 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-red-500/30">
                            <div class="bg-red-500 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                                <i class="fas fa-users text-white text-3xl"></i>
                            </div>
                            <h3 class="text-xl md:text-2xl font-bold text-white mb-3">Lifetime Community</h3>
                            <p class="text-gray-300 leading-relaxed">
                                Join our exclusive alumni network for future workshops, events, and industry updates
                            </p>
                        </div>

                        <!-- Benefit 7 -->
                        <div class="group bg-gradient-to-br from-pink-500/20 to-pink-600/10 backdrop-blur-lg p-6 md:p-8 rounded-3xl border-2 border-pink-400/30 hover:border-pink-400 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-pink-500/30">
                            <div class="bg-pink-500 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                                <i class="fas fa-book text-white text-3xl"></i>
                            </div>
                            <h3 class="text-xl md:text-2xl font-bold text-white mb-3">Training Materials</h3>
                            <p class="text-gray-300 leading-relaxed">
                                Digital learning resources, drone operation guides, and safety manuals to keep forever
                            </p>
                        </div>

                        <!-- Benefit 8 -->
                        <div class="group bg-gradient-to-br from-indigo-500/20 to-indigo-600/10 backdrop-blur-lg p-6 md:p-8 rounded-3xl border-2 border-indigo-400/30 hover:border-indigo-400 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-indigo-500/30">
                            <div class="bg-indigo-500 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                                <i class="fas fa-trophy text-white text-3xl"></i>
                            </div>
                            <h3 class="text-xl md:text-2xl font-bold text-white mb-3">Competition Prep</h3>
                            <p class="text-gray-300 leading-relaxed">
                                Preparation for national drone competitions and career guidance in aviation technology
                            </p>
                        </div>

                        <!-- Benefit 9 -->
                        <div class="group bg-gradient-to-br from-teal-500/20 to-teal-600/10 backdrop-blur-lg p-6 md:p-8 rounded-3xl border-2 border-teal-400/30 hover:border-teal-400 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-teal-500/30">
                            <div class="bg-teal-500 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                                <i class="fas fa-headset text-white text-3xl"></i>
                            </div>
                            <h3 class="text-xl md:text-2xl font-bold text-white mb-3">Post-Camp Support</h3>
                            <p class="text-gray-300 leading-relaxed">
                                30-day WhatsApp support group for questions, troubleshooting, and continued learning
                            </p>
                        </div>
                    </div>

                    <!-- Call to Action -->
                    <div class="bg-gradient-to-r from-blue-500 to-cyan-400 rounded-3xl p-8 md:p-12 text-center shadow-2xl hover:shadow-blue-500/50 transition-all duration-300">
                        <h3 class="text-3xl md:text-4xl font-black text-white mb-4">
                            <i class="fas fa-rocket mr-3"></i>Limited Seats Available!
                        </h3>
                        <p class="text-lg md:text-xl text-white/90 mb-6 max-w-3xl mx-auto">
                            Only 30 students per batch to ensure personalized attention and maximum flying time
                        </p>
                        <a href="#register" class="inline-block bg-white text-blue-600 px-10 py-5 rounded-full text-xl font-bold hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-white/50">
                            Register Now for ₹2,500 <i class="fas fa-arrow-right ml-2"></i>
                        </a>
                    </div>
                </div>
            </div>
  ...
  const content = `
    <div class="pt-32 pb-20 bg-gray-50">
        <div class="container mx-auto px-4 md:px-6 max-w-4xl">
            <h1 class="text-4xl md:text-5xl font-black mb-6 text-center">Privacy <span class="gradient-text">Policy</span></h1>
            <p class="text-center text-gray-600 mb-12">Last Updated: March 26, 2026</p>
            
            <div class="bg-white rounded-3xl shadow-lg p-6 md:p-10 space-y-8">
                <!-- Introduction -->
                <section>
                    <h2 class="text-2xl md:text-3xl font-bold mb-4 text-gray-800">1. Introduction</h2>
                    <p class="text-gray-700 leading-relaxed mb-4">
                        Welcome to FLYQ Drones ("we," "our," or "us"). We are committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website <strong>flyqdrone.in</strong> and use our services.
                    </p>
                ...
                <section>
                    <h2 class="text-2xl md:text-3xl font-bold mb-4 text-gray-800">2. Information We Collect</h2>
                    
                    <h3 class="text-xl font-semibold mb-3 text-gray-800">2.1 Personal Information</h3>
                    ...
                    <p class="text-gray-700 leading-relaxed mb-4">
                        This information may include: name, email address, phone number, shipping address, billing address, payment information, and any other information you choose to provide.
                    </p>

                    <h3 class="text-xl font-semibold mb-3 text-gray-800">2.2 Automatically Collected Information</h3>
                    <p class="text-gray-700 leading-relaxed mb-3">
                ...
                <section>
                    <h2 class="text-2xl md:text-3xl font-bold mb-4 text-gray-800">3. How We Use Your Information</h2>
                    <p class="text-gray-700 leading-relaxed mb-3">
                    ...
                    <ul class="list-disc list-inside text-gray-700 space-y-2 mb-4 ml-4">
                        ...
                        <li><strong>Marketing Communications:</strong> To send you promotional emails about new products, special offers, and other information (you can opt-out anytime)</li>
                ...
                <!-- Information Sharing -->
                <section>
                    <h2 class="text-2xl md:text-3xl font-bold mb-4 text-gray-800">4. Information Sharing and Disclosure</h2>
                    <p class="text-gray-700 leading-relaxed mb-3">
                ...
                <section>
                    <h2 class="text-2xl md:text-3xl font-bold mb-4 text-gray-800">5. Cookies and Tracking Technologies</h2>
                    <p class="text-gray-700 leading-relaxed mb-4">
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        We use cookies for: session management, user preferences, security, and analytics.
                    </p>
                </section>

                <!-- Data Security -->
                <section>
                    <h2 class="text-2xl md:text-3xl font-bold mb-4 text-gray-800">6. Data Security</h2>
                    <p class="text-gray-700 leading-relaxed mb-4">
                ...
                <!-- Data Retention -->
                <section>
                    <h2 class="text-2xl md:text-3xl font-bold mb-4 text-gray-800">7. Data Retention</h2>
                    <p class="text-gray-700 leading-relaxed">
                ...
                <!-- Your Rights -->
                <section>
                    <h2 class="text-2xl md:text-3xl font-bold mb-4 text-gray-800">8. Your Privacy Rights</h2>
                    <p class="text-gray-700 leading-relaxed mb-3">
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        To exercise these rights, please contact us at <a href="mailto:privacy@flyqdrone.in" class="text-blue-600 hover:underline">privacy@flyqdrone.in</a>
                    </p>
                </section>

                <!-- Third-Party Links -->
                <section>
                    <h2 class="text-2xl md:text-3xl font-bold mb-4 text-gray-800">9. Third-Party Links</h2>
                    <p class="text-gray-700 leading-relaxed">
                ...
                <!-- Children's Privacy -->
                <section>
                    <h2 class="text-2xl md:text-3xl font-bold mb-4 text-gray-800">10. Children's Privacy</h2>
                    <p class="text-gray-700 leading-relaxed">
                ...
                <section>
                    <h2 class="text-2xl md:text-3xl font-bold mb-4 text-gray-800">11. International Data Transfers</h2>
                    <p class="text-gray-700 leading-relaxed">
                ...
                <section>
                    <h2 class="text-2xl md:text-3xl font-bold mb-4 text-gray-800">12. Changes to This Privacy Policy</h2>
                    <p class="text-gray-700 leading-relaxed">
                ...
                <!-- Contact Information -->
                <section>
                    <h2 class="text-2xl md:text-3xl font-bold mb-4 text-gray-800">13. Contact Us</h2>
                    <p class="text-gray-700 leading-relaxed mb-4">
                        If you have any questions, concerns, or requests regarding this Privacy Policy or our privacy practices, please contact us:
                    </p>
                    <div class="bg-gray-50 p-6 rounded-xl">
                        <p class="text-gray-800 font-semibold mb-2">FLYQ Drones</p>
                        <p class="text-gray-700">Email: <a href="mailto:privacy@flyqdrone.in" class="text-blue-600 hover:underline">privacy@flyqdrone.in</a></p>
                        <p class="text-gray-700">Website: <a href="https://flyqdrone.in" class="text-blue-600 hover:underline">flyqdrone.in</a></p>
                        <p class="text-gray-700 mt-3">We will respond to your inquiry within 30 days.</p>
                    </div>
                </section>

                <!-- Consent -->
                <section class="border-t-2 border-gray-200 pt-6">
                    <h2 class="text-2xl md:text-3xl font-bold mb-4 text-gray-800">14. Your Consent</h2>
                    <p class="text-gray-700 leading-relaxed">
                        By using our website and services, you consent to our Privacy Policy and agree to its terms. If you do not agree to this policy, please do not use our website or services.
                    </p>
                </section>
            </div>
            ...
            <!-- Back to Home -->
            <div class="text-center mt-12">
                <a href="/" class="inline-block bg-gradient-to-r from-blue-600 to-cyan-500 text-white px-8 py-4 rounded-full font-bold text-lg hover:shadow-2xl hover:shadow-blue-500/50 transition-all duration-300">
