  ...
  return `
    ...
    <head>
        ...
        <style>
            ...
            /* USER REVEAL Intro Animation - No Drone */
            #intro-animation {
                position: fixed;
                top: 0;
                left: 0;
            ...
            .flyq-text {
                ...
                display: flex;
                gap: 30px;
                text-shadow: 0 0 60px rgba(14, 165, 233, 0.9),
            ...
            /* Ring pulse effect around letters */
            @keyframes ringPulse {
                0% {
                    width: 0;
                    height: 0;
                ...
                letters.forEach((letter, index) => {
                    setTimeout(() => {
                        ...
                        for (let i = 0; i < 40; i++) {
                            ...
                            const relX = letterRect.left - containerRect.left + letterRect.width / 2;
                            const relY = letterRect.top - containerRect.top + letterRect.height / 2;
...
app.get('/track/:id', (c) => {
  ...
  return c.html('<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title>Track Order - ' + safeTrackingId + '</title><script src="https://cdn.tailwindcss.com"></script><link href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.0/css/all.min.css" rel="stylesheet"></head><body class="bg-gray-50"><div class="container mx-auto px-6 py-12 max-w-5xl"><div class="bg-white rounded-3xl shadow-2xl overflow-hidden mb-8"><div class="bg-gradient-to-r from-blue-600 to-cyan-500 p-6 text-white"><div class="flex items-center justify-between flex-wrap gap-4"><div><div class="text-sm opacity-90 mb-1">Tracking ID</div><div class="text-2xl font-bold font-mono">' + safeTrackingId + '</div></div><div class="bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full"><div class="text-sm opacity-90 mb-1">Status</div><div class="text-xl font-bold">🚚 In Transit</div></div></div></div><div class="p-8 bg-gradient-to-br from-blue-50 to-cyan-50"><div class="flex items-center justify-between mb-6"><div class="text-center flex-1"><div class="w-16 h-16 bg-green-500 rounded-full mx-auto flex items-center justify-center text-white text-2xl mb-2 shadow-lg"><i class="fas fa-map-marker-alt"></i></div><div class="font-bold text-gray-800">Mumbai</div><div class="text-sm text-gray-600">Origin</div></div><div class="flex-1 relative" style="height:4px;background:linear-gradient(to right,#10b981 0%,#3b82f6 50%,#94a3b8 100%);margin:0 20px;border-radius:2px;"><div style="position:absolute;top:50%;left:50%;width:16px;height:16px;background:#3b82f6;border:3px solid white;border-radius:50%;transform:translate(-50%,-50%);animation:pulse 2s infinite;"></div></div><div class="text-center flex-1"><div class="w-16 h-16 bg-blue-500 rounded-full mx-auto flex items-center justify-center text-white text-2xl mb-2 shadow-lg"><i class="fas fa-map-pin"></i></div><div class="font-bold text-gray-800">Your Location</div><div class="text-sm text-gray-600">Destination</div></div></div><div class="text-center text-sm text-gray-600 bg-white/50 backdrop-blur-sm rounded-lg p-3"><i class="fas fa-truck-moving mr-2 text-blue-600"></i>Your package is on its way from <strong>Mumbai</strong> to your location</div></div><div class="p-8"><h3 class="text-2xl font-bold text-gray-800 mb-6"><i class="fas fa-clock text-blue-600 mr-2"></i>Shipment Timeline</h3><div class="space-y-6"><div class="flex gap-4"><div class="flex flex-col items-center"><div class="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center text-white shadow-lg"><i class="fas fa-check"></i></div><div class="w-1 h-full bg-green-300 mt-2"></div></div><div class="flex-1 pb-8"><div class="bg-green-50 border-l-4 border-green-500 rounded-r-lg p-4"><div class="font-bold text-gray-800 text-lg mb-1">Order Confirmed</div><div class="text-gray-600 text-sm">Your order has been received and confirmed</div><div class="text-gray-500 text-xs mt-1">Mumbai Hub</div></div></div></div><div class="flex gap-4"><div class="flex flex-col items-center"><div class="w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center text-white shadow-lg"><i class="fas fa-box"></i></div><div class="w-1 h-full bg-blue-300 mt-2"></div></div><div class="flex-1 pb-8"><div class="bg-blue-50 border-l-4 border-blue-500 rounded-r-lg p-4"><div class="font-bold text-gray-800 text-lg mb-1">Picked Up</div><div class="text-gray-600 text-sm">Package picked up from warehouse</div><div class="text-gray-500 text-xs mt-1">Mumbai Warehouse, Maharashtra</div></div></div></div><div class="flex gap-4"><div class="flex flex-col items-center"><div class="w-12 h-12 bg-purple-500 rounded-full flex items-center justify-center text-white shadow-lg animate-pulse"><i class="fas fa-truck"></i></div><div class="w-1 h-full bg-gray-300 mt-2"></div></div><div class="flex-1 pb-8"><div class="bg-purple-50 border-l-4 border-purple-500 rounded-r-lg p-4"><div class="font-bold text-gray-800 text-lg mb-1">In Transit</div><div class="text-gray-600 text-sm">Your package is on the way</div><div class="text-gray-500 text-xs mt-1">En route to destination</div><div class="mt-3 bg-purple-100 rounded-lg p-2 text-center text-sm font-semibold text-purple-700"><i class="fas fa-clock mr-1"></i>Expected Delivery: 5-7 business days</div></div></div></div><div class="flex gap-4 opacity-50"><div class="flex flex-col items-center"><div class="w-12 h-12 bg-gray-300 rounded-full flex items-center justify-center text-white"><i class="fas fa-check-double"></i></div></div><div class="flex-1"><div class="bg-gray-50 border-l-4 border-gray-300 rounded-r-lg p-4"><div class="font-bold text-gray-600 text-lg mb-1">Delivered</div><div class="text-gray-500 text-sm">Pending</div></div></div></div></div></div><div class="p-6 bg-blue-50 border-t border-blue-200 text-center"><h4 class="font-bold text-xl text-gray-800 mb-2"><i class="fas fa-info-circle text-blue-600 mr-2"></i>Want More Details?</h4><p class="text-gray-600 mb-4">Login to see complete order information and delivery address</p><a href="/login?redirect=/account/orders" class="inline-block bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 transition"><i class="fas fa-sign-in-alt mr-2"></i>Login for Full Details</a></div><div class="p-6 bg-gradient-to-r from-blue-600 to-cyan-500 text-white text-center"><h4 class="font-bold text-xl mb-2">Need Help?</h4><p class="mb-4 opacity-90">Contact our support team</p><div class="flex justify-center gap-4 flex-wrap"><a href="mailto:support@flyqdrones.com" class="bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition"><i class="fas fa-envelope mr-2"></i>Email</a><a href="https://wa.me/919137361474" target="_blank" class="bg-green-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-700 transition"><i class="fab fa-whatsapp mr-2"></i>WhatsApp</a></div></div></div><div class="text-center"><a href="/" class="inline-block bg-white text-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-50 transition shadow-lg"><i class="fas fa-arrow-left mr-2"></i>Back to Home</a></div></div><style>@keyframes pulse{0%,100%{box-shadow:0 0 0 0 rgba(59,130,246,0.7)}50%{box-shadow:0 0 0 10px rgba(59,130,246,0)}}</style></body></html>');
});
