...
const sampleOrder = {
  customer_name: 'Rahul Gupta (Test)',
  email: 'rahulgupta37079@gmail.com',
  order_number: 'FLYQ-TEST-123456',
  total: 7999,
  product_name: 'FLYQ Air',
  tracking_id: 'TRK-TEST-SAMPLE',
  shipping_id: 'SHIP-TEST-SAMPLE'
};
            ...
            <td style="padding: 20px 40px;">
              <div style="background: #fef5e7; border-left: 4px solid #f59e0b; padding: 15px; border-radius: 8px;">
                <p style="margin: 0; color: #92400e; font-size: 14px;">
                  <strong>📧 This is a SAMPLE email</strong> showing what your 63 customers received with their login credentials, order details, and tracking information.
                </p>
              </div>
            </td>
          </tr>
...
(async () => {
  try {
    console.log('📧 Sending sample email to rahulgupta37079@gmail.com...\n');
    
    await resend.emails.send({
      from: 'FLYQ Drones <orders@flyqdrones.com>',
      to: 'rahulgupta37079@gmail.com',
      subject: '🚁 SAMPLE: Welcome to FLYQ! Order Confirmation',
      html: emailHtml
    });
    ...
    console.log('\nThis is exactly what all 63 customers received! ✨');
