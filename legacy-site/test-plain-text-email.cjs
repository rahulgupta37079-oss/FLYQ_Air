        ...
        <table role="presentation" style="width: 600px; max-width: 100%; background: white; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 20px 40px;">
              <div style="background: #fef5e7; border-left: 4px solid #f59e0b; padding: 15px; border-radius: 8px;">
                <p style="margin: 0; color: #92400e; font-size: 14px;">
                  <strong>📧 TEST EMAIL</strong> - URLs are plain text (copy/paste) to avoid click tracking issues.
                </p>
              </div>
            </td>
          </tr>
            ...
            <td style="padding: 0 40px 30px;">
              <div style="background: #e0f2fe; border-left: 4px solid #0284c7; padding: 20px; border-radius: 8px;">
                ...
                <p style="margin: 15px 0 0; padding: 10px; background: #fff3cd; border-radius: 4px; color: #856404; font-size: 13px;">
                  <strong>⚠️ Important:</strong> These URLs are plain text. Select, copy (Ctrl+C or Cmd+C), and paste (Ctrl+V or Cmd+V) into your browser's address bar.
                </p>
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 0 40px 30px;">
              ...
              <ol style="margin: 0; padding-left: 20px; color: #4a5568; font-size: 14px; line-height: 1.8;">
                ...
                <li><strong>Copy the URLs above</strong> and paste them in your browser</li>
...
(async () => {
  try {
    console.log('📧 Sending TEST email with PLAIN TEXT URLs...\n');
    console.log('   ✅ No clickable links - URLs are plain text');
    console.log('   ✅ Customers will copy/paste them');
    console.log('   ✅ No click tracking wrapper issues!\n');
    
    const result = await resend.emails.send({
      from: 'FLYQ Drones <onboarding@resend.dev>',
      to: 'rahulgupta37079@gmail.com',
      subject: '🚁 TEST: Welcome to FLYQ! Order ' + sampleOrder.order_number + ' Confirmed',
      html: emailHtml,
      tags: [
    ...
    console.log('📬 You should see plain text URLs (no clickable links)');
    console.log('\n🎯 This format will be sent to all 63 customers');
    console.log('🔗 Customers will copy/paste URLs - no tracking issues!');
